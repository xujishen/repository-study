...
var _INCLUDES =	  '<script type="text/javascript" src="' + _CONTEXTPATH + '/js/common/jquery-3.1.1.min.js?num=' + ranNum + '"></script>'
				...
				+ '<script type="text/javascript" src="' + _CONTEXTPATH + '/js/layer/layer.js?num=' + ranNum + '"></script>'
				+ '<script type="text/javascript" src="' + _CONTEXTPATH + '/js/common/dateFormat.js?num=' + ranNum + '"></script>'
			   	+ '<script type="text/javascript" src="' + _CONTEXTPATH + '/js/common/commonFunction.js?num=' + ranNum + '"></script>'
				+ '<script type="text/javascript" src="' + _CONTEXTPATH + '/js/common/Timer.js?num=' + ranNum + '"></script>'
				+ '<script type="text/javascript" src="' + _CONTEXTPATH + '/js/common/CommonBean.js?num=' + ranNum + '"></script>'
				+ '<script type="text/javascript" src="' + _CONTEXTPATH + '/js/common/extend.js?num=' + ranNum + '"></script>'
